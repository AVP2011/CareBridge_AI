...
const RESOURCES: Resource[] = [
  ...
  { title:"IRDAI Bima Bharosa (formerly IGMS)", description:"Official portal to file and track insurance complaints. If your insurer hasn't resolved your complaint in 15 days, escalate here. Creates an official paper trail.", source:"IRDAI Bima Bharosa", type:"Portal", category:"Grievance", url:"https://bimabharosa.irdai.gov.in/", tags:["Bima Bharosa","complaint","grievance","escalation"] },
